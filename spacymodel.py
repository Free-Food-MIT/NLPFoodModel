...
def find_food(email):
	...
	terms_list = ['ice cream', 'cookies', 'cookie', 'pizza', 'pizzas', 'burritos', 'burrito', 'waffle', 'waffles', 'food', 'free food', 'snack', 'snacks', 'boba']
...
Subject: [Free-food] Free Taco Bar food in W20-202 (La Sala)!! eom
